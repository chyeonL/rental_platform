      ...
      >
       <el-form-item prop='Title'>
        ...
        <el-form-item  prop='Status'>
           <label>处理阶段</label>
           <el-select v-model="form.Status" clearable placeholder="请选择" disabled>
        ...
        <el-form-item prop='Response' v-if="form.Response">
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      this.$store
        .dispatch("DetailMyOpinion", this.$route.query.No)
        .then((res) => {
          this.form = res;
      ...
      this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          this.$confirm("确认编辑当前意见?", "确认编辑", {
            ...
            .then(() => {
              this.$store
                .dispatch("ModifyMyOpinion", this.form)
                .then((res) => {
                  // console.log(res);
                  this.EditHandler();
                });
